...
void WalletGUI::StratumClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::startedSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (StratumClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::stoppedSignal)) {
                *result = 1;
            }
        }
        {
            typedef void (StratumClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::socketErrorSignal)) {
                *result = 2;
            }
        }
        {
            typedef void (StratumClient::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::difficultyChangedSignal)) {
                *result = 3;
            }
        }
        {
            typedef void (StratumClient::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::goodShareCountChangedSignal)) {
                *result = 4;
            }
        }
        {
            typedef void (StratumClient::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::badShareCountChangedSignal)) {
                *result = 5;
            }
        }
        {
            typedef void (StratumClient::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::connectionErrorCountChangedSignal)) {
                *result = 6;
            }
        }
        {
            typedef void (StratumClient::*_t)(const QDateTime & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StratumClient::lastConnectionErrorTimeChangedSignal)) {
                *result = 7;
            }
        }
    }
...
const QMetaObject WalletGUI::StratumClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WalletGUI__StratumClient.data,
      qt_meta_data_WalletGUI__StratumClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::StratumClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__StratumClient.stringdata0))
        return static_cast<void*>(const_cast< StratumClient*>(this));
    if (!strcmp(_clname, "IPoolClient"))
        return static_cast< IPoolClient*>(const_cast< StratumClient*>(this));
    if (!strcmp(_clname, "IMinerWorkerObserver"))
        return static_cast< IMinerWorkerObserver*>(const_cast< StratumClient*>(this));
