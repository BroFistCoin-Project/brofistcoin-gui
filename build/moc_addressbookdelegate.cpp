...
#include "../src/addressbookdelegate.h"
...
QT_MOC_LITERAL(4, 54, 5), // "label"
QT_MOC_LITERAL(5, 60, 10), // "editSignal"
QT_MOC_LITERAL(6, 71, 6), // "_index"
QT_MOC_LITERAL(7, 78, 12) // "deleteSignal"

    },
    "WalletGUI::AddressBookDelegate\0"
    "sendToSignal\0\0_address\0label\0editSignal\0"
...
void WalletGUI::AddressBookDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AddressBookDelegate::*_t)(const QString & , const QString & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddressBookDelegate::sendToSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (AddressBookDelegate::*_t)(const QPersistentModelIndex & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddressBookDelegate::editSignal)) {
                *result = 1;
            }
        }
        {
            typedef void (AddressBookDelegate::*_t)(const QPersistentModelIndex & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddressBookDelegate::deleteSignal)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject WalletGUI::AddressBookDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_WalletGUI__AddressBookDelegate.data,
      qt_meta_data_WalletGUI__AddressBookDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::AddressBookDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__AddressBookDelegate.stringdata0))
        return static_cast<void*>(const_cast< AddressBookDelegate*>(this));
...
// SIGNAL 0
void WalletGUI::AddressBookDelegate::sendToSignal(const QString & _t1, const QString & _t2)const
{
