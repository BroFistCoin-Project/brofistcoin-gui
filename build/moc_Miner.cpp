...
void WalletGUI::Miner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::stateChangedSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::hashRateChangedSignal)) {
                *result = 1;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::alternateHashRateChangedSignal)) {
                *result = 2;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::difficultyChangedSignal)) {
                *result = 3;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::goodShareCountChangedSignal)) {
                *result = 4;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::goodAlternateShareCountChangedSignal)) {
                *result = 5;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::badShareCountChangedSignal)) {
                *result = 6;
            }
        }
        {
            typedef void (Miner::*_t)(quint32 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::connectionErrorCountChangedSignal)) {
                *result = 7;
            }
        }
        {
            typedef void (Miner::*_t)(const QDateTime & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Miner::lastConnectionErrorTimeChangedSignal)) {
                *result = 8;
            }
        }
    }
...
const QMetaObject WalletGUI::Miner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WalletGUI__Miner.data,
      qt_meta_data_WalletGUI__Miner,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::Miner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__Miner.stringdata0))
        return static_cast<void*>(const_cast< Miner*>(this));
    if (!strcmp(_clname, "IPoolMiner"))
        return static_cast< IPoolMiner*>(const_cast< Miner*>(this));
    if (!strcmp(_clname, "IPoolClientObserver"))
        return static_cast< IPoolClientObserver*>(const_cast< Miner*>(this));
