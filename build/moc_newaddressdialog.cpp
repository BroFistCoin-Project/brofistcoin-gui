...
void WalletGUI::NewAddressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NewAddressDialog *_t = static_cast<NewAddressDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject WalletGUI::NewAddressDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_WalletGUI__NewAddressDialog.data,
      qt_meta_data_WalletGUI__NewAddressDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::NewAddressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__NewAddressDialog.stringdata0))
        return static_cast<void*>(const_cast< NewAddressDialog*>(this));
