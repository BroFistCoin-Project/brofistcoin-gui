/****************************************************************************
** Meta object code from reading C++ file 'addressbooksortedmodel.h'
**
...
#include "../src/addressbooksortedmodel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'addressbooksortedmodel.h' doesn't include <QObject>."
...
const QMetaObject WalletGUI::SortedAddressBookModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_WalletGUI__SortedAddressBookModel.data,
      qt_meta_data_WalletGUI__SortedAddressBookModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::SortedAddressBookModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__SortedAddressBookModel.stringdata0))
        return static_cast<void*>(const_cast< SortedAddressBookModel*>(this));
