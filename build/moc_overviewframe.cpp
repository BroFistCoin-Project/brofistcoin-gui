...
void WalletGUI::OverviewFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OverviewFrame *_t = static_cast<OverviewFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (OverviewFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OverviewFrame::copiedToClipboardSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject WalletGUI::OverviewFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WalletGUI__OverviewFrame.data,
      qt_meta_data_WalletGUI__OverviewFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WalletGUI::OverviewFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WalletGUI__OverviewFrame.stringdata0))
        return static_cast<void*>(const_cast< OverviewFrame*>(this));
